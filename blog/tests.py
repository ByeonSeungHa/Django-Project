...
class TestView(TestCase):
    ...
    def test_create_post(self):
        # 로그인하지 않으면 status comd가 200이면 안됀다.
    ...
    def test_update_post(self):
        ...
        tag_str_input = main_area.find('input', id='id_tags_str')
        self.assertTrue(tag_str_input)
        self.assertIn('고기연구; 소고기', tag_str_input.attrs['value'])
        ...
        response = self.client.post(
            update_post_url,
            {
                ...
                'category': self.category_애완멍멍이.pk,
        ...
        self.assertIn(self.category_애완멍멍이.name, main_area.text)
